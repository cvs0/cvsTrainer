...
const ColorRgba
	MenuItemDefault_colorRect			{ 194, 107, 242, 150 },		
	MenuItemDefault_colorText			{ 255, 255, 255, 150 },		
	MenuItemDefault_colorRectActive		{ 191, 19, 162, 200 },
...
public:
	...
	{
		return {
			IsKeyDown(VK_NUMPAD5) || IsKeyDown(VK_RETURN),
			IsKeyDown(VK_NUMPAD0) || IsKeyDown(VK_BACK),
			IsKeyDown(VK_NUMPAD8) || IsKeyDown(VK_UP),
			IsKeyDown(VK_NUMPAD2) || IsKeyDown(VK_DOWN),
			IsKeyDown(VK_NUMPAD6) || IsKeyDown(VK_RIGHT),
			IsKeyDown(VK_NUMPAD4) || IsKeyDown(VK_LEFT)
		};
	}
